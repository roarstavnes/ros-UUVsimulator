...
class Observer:
    def __init__(self):
        ...
        self.Q_d    = np.diag([0.001, 0.001, 0.001, 0.00001, 0.00001, 0.00001, 0.001, 0.001, 0.001, 0.00001, 0.00001, 0.00001])
        self.Rd     = np.array([0.01, 0.01, 0.01, 0.005, 0.005, 0.005, 0.001, 0.001, 0.005]) 
